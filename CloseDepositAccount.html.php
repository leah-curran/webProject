...
<!-- Call a javascript function to look up the customer by ID -->
...
while ($row = mysqli_fetch_array($result))
    {
        ...
        // Display the first and second name in the dropdown
...
<form action="close_deposit.php" method="post" onsubmit="return validation()">

    <!-- Hidden field to pass the customer ID into the form -->
    <input type="hidden" name="cust_id" id="cust_id" />

    <!-- Hidden field to pass the deposit account ID into the form -->
    <input type="hidden" name="delid" id="delid" />

    <!-- Hidden field to pass the balance into the form for validation -->
...
<script src="closedeposit.js"></script>
</body>
</html>